...
function GameReservation() {
  ...
  function clickPlace(id) {
    ...
    if(document.getElementById(id).classList != 'taken') {
  ...
  function payerPlace() {
    ...
    if (countPlaces != 0) {
      const confirmPayment = window.confirm('Êtes-vous sûr de vouloir payer les places sélectionnées ?');
      if (confirmPayment) {
      ...
      alert("Vous n'avez pas sélectionné de place")
    }
  }
      ...
      <div className="container--tickets">
        {section !== '' ? (
          <div className="ticketsSelect">
            ...
            <button id="PAYE" onClick={() => payerPlace()}>PAYE</button>
          </div>
        ) : (
